...
export const metadata: Metadata = {
  title:
    "FORST EYE CLINIC Surulere | Best Eye Clinic in Surulere, Lagos",
  description:
    "Visit FORST EYE CLINIC Surulere for comprehensive eye examinations, glaucoma screening, cataract assessment, diabetic eye screening, children's eye care, dry eye treatment, OCT imaging and premium optical services.",
  keywords: [
    "Eye Clinic Surulere",
    "Best Eye Clinic Surulere",
    "Eye Hospital Surulere",
    "Optometrist Surulere",
    "Eye Doctor Surulere",
    "Glaucoma Clinic Surulere",
    "Eye Examination Surulere",
    "Optical Store Surulere",
    "FORST EYE CLINIC",
  ],
  alternates: {
    canonical: "/branches/surulere",
  },
};
...
export default function SurulereBranchPage() {
  return (
    <main className="bg-white">
      ...
      <section className="bg-neutral-50 py-16 lg:py-24">
        <div className="container-site max-w-6xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-neutral-600">
            Welcome to FORST EYE CLINIC Surulere, where we provide modern,
            patient-centered eye care using advanced diagnostic technology.
            Our experienced eye care professionals are committed to helping
            individuals and families enjoy clearer, healthier vision.
          </p>
        ...
        <div className="container-site max-w-6xl">
          <div className="grid gap-8 lg:grid-cols-3">
            ...
            <div className="rounded-3xl border border-neutral-200 p-8 text-center shadow-sm">
              ...
              <p className="mt-3 leading-7 text-neutral-600">
                Comprehensive eye care, experienced clinicians, advanced
                diagnostic equipment and premium optical services in one
                convenient location.
              </p>
            </div>
          </div>
        ...
        <div className="container-site max-w-6xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 leading-8 text-neutral-600">
              Our Surulere branch offers comprehensive eye care services for
      ...
      <section className="py-16 lg:py-20">
        <div className="container-site max-w-5xl text-center">
          <h2 className="text-3xl font-bold text-neutral-900">
            Professional Eye Care in Surulere
          </h2>

          <p className="mx-auto mt-6 max-w-3xl leading-8 text-neutral-600">
            Whether you require a routine eye examination, glaucoma screening,
            diabetic eye screening, children's eye care, cataract evaluation
            or premium optical services, our Surulere branch is committed to
            delivering high-quality eye care with compassion, professionalism
      ...
      <section className="pb-16">
        <div className="container-site max-w-6xl">
          <div className="overflow-hidden rounded-3xl border border-neutral-200 shadow-sm">
            <iframe
              src="YOUR_SURULERE_GOOGLE_MAP_EMBED_LINK"
              width="100%"
              height="450"
              loading="lazy"
              style={{ border: 0 }}
        ...
        <div className="container-site">
          <div className="mx-auto max-w-5xl rounded-3xl border border-primary/10 bg-white p-10 text-center shadow-lg">
            <h2 className="text-3xl font-bold text-neutral-900 lg:text-4xl">
              Book Your Visit to Our Surulere Branch
            </h2>

            <p className="mx-auto mt-5 max-w-3xl leading-8 text-neutral-600">
              Looking for the best eye clinic in Surulere? Visit FORST EYE
              CLINIC for comprehensive eye examinations, glaucoma management,
              diabetic eye screening, children's eye care, cataract assessment
              and quality optical services delivered by experienced eye care
              professionals.
            </p>
